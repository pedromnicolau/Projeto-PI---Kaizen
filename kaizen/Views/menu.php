<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
      echo "<div class='dropdown'><button class='mainmenubtn' onclick='window.location.href=\"login\"'>
      ...
      <div class='dropdown-child'>
        <a href='metas.html'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='lucide lucide-goal'><path d='M12 13V2l8 4-8 4'/><path d='M20.561 10.222a9 9 0 1 1-12.55-5.29'/><path d='M8.002 9.997a5 5 0 1 0 8.9 2.02'/></svg>  
        Metas</a><br><br>
        <a href='progresso.html'>
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='lucide lucide-bar-chart-4'><path d='M3 3v18h18'/><path d='M13 17V9'/><path d='M18 17V5'/><path d='M8 17v-3'/></svg>  
        Progresso</a><br><br>
        <a href='logout.html'>
